...
public class UserControllerTestMvc {
    ...
    @MockBean
    UserRequestDtoMapper requestDtoMapper;
    @MockBean
    UserResponseDtoMapper responseDtoMapper;
    ...
    public void create_notValidInputDto_notOk() throws Exception {
        ...
        when(userService.create(user))
                .thenThrow(IllegalArgumentException.class); //MethodArgumentNotValidException
    ...
    public void create_notValidPhoneNumber_notOk() throws Exception {
        userRequestDto.setPhoneNumber("1");
        when(requestDtoMapper.mapToModel(userRequestDto)).thenReturn(user);
    ...
    public void getAllByBirthDateBetween_ok() throws Exception {
        ...
        mvc.perform(get("/users")
                ...
                .andExpect(jsonPath("$[0].birthDate").value(userResponseDtos.get(0).getBirthDate().toString()));
    }
